import { test } from '../../fixtures/base.sanity.fixture';
...
test.describe('Dashboard', () => {
  ...
  test('Verify product prices are displayed correctly', async ({ loginPage, productListPage }) => {
    await loginPage.login(Env.standardUser, Env.password);
    await productListPage.getProductPrices();
  });

  test('Verify product names are displayed correctly', async ({ loginPage, productListPage }) => {
    await loginPage.login(Env.standardUser, Env.password);
    await productListPage.getProductNames();
  });

  test('Verify sorted product prices in ascending order are displayed correctly', async ({ loginPage, productListPage }) => {
    await loginPage.login(Env.standardUser, Env.password);
  ...
  test('Verify sorted product prices in descending order are displayed correctly', async ({ loginPage, productListPage }) => {
    await loginPage.login(Env.standardUser, Env.password);
  ...
  test('Verify sorted product names in ascending order are displayed correctly', async ({ loginPage, productListPage }) => {
    await loginPage.login(Env.standardUser, Env.password);
  ...
  test('Verify sorted product names in descending order are displayed correctly', async ({ loginPage, productListPage }) => {
    await loginPage.login(Env.standardUser, Env.password);
